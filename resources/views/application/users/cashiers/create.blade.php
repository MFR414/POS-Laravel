        ...
        <section>
            <div>
                <div class="title-block">
                    <h1 class="title">Tambah kasir</h1>
                    <p class='title-description'>Gunakan form dibawah untuk menambahkan kasir baru kedalam aplikasi.</p>
                </div>
            </div>
        </section>
        <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title-body">
                                <h3 class="title">Tambah super kasir</h3>
                            </div>
                            <form action="{{ route('application.users.cashiers.store') }}" method="POST" style="margin-bottom: 0">
                                {{ csrf_field() }}
                                <section>
                                    <div class="row">
